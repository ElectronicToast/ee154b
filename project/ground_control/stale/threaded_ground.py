...
def main(args):
    ...
    # t_input = multiprocessing.Process(target=input_loop)
    # t_lifeline = multiprocessing.Process(target=lifeline_loop)
    
    t_input = groundthread.GroundThread(input_loop)
    t_lifeline = groundthread.GroundThread(lifeline_loop)
