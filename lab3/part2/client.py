...
This client module allows communications to and from an XTEND vB RF module
with an Arduino Uno connected to a host laptop over UART. The RSSI difference
PWM output from the radio to the Arduino is displayed. The user may
send

usage: client.py [-h] [-l [LOG_FILENAME]] [-R [BAUD_RATE]]
...
Possible commands are:
    0: Send a payload string input to another radio
    1: Listen for transmissions from another radio, stream to command line
'''
